...
class MultiHeadAttention:
    ...
    def _split_heads(self, x):
        ...
        x = x.reshape(N, L, self.num_heads, embed_dim // self.num_heads)
    ...
    def _concat_heads(self, x):
        ...
        N, L, e = x.shape[0], x.shape[2], x.shape[3]
        ...
        x = x.reshape(N, L, self.num_heads * e)

...
class BatchNorm1d:
    ...
    def forward(self, Z, eval=False):
        ...
        self.M = np.mean(self.Z, axis = 0)  # TODO: Calculate mini-batch mean
        self.V = np.var(self.Z, axis = 0)  # TODO: Calculate mini-batch variance
    ...
    def backward(self, dLdBZ):
        ...
        dLdZ = dLdNZ*np.power(self.V + self.eps, -0.5) + dLdV *(self.Z - self.M)*2/self.N + dLdM/self.N  # TODO: Compute gradient of loss with respect to the input.
